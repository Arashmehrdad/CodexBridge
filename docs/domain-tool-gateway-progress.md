...
- Files changed so far: `soma/gateway_models.py`, `tests/test_tool_gateway_models.py`, this journal.
...
- Files changed so far: `soma/gateway_models.py`, `soma/server.py`, discovery/server/model tests, and this journal.
...
- Files changed so far: Phase 1 files plus `soma/run_store.py`, `soma/job_manager.py`, and `tests/test_run_store.py`.
...
- Files changed so far: Phase 0–3 files plus `soma/gateway_models.py`, `soma/server.py`, focused discovery/model tests, and this journal.
...
- Files changed so far: Phase 0–4 files plus strict run-start models, `soma/server.py`, focused discovery/model tests, and this journal.
