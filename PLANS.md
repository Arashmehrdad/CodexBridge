...
- Next unit: design the smallest durable validation adapter for those three callers, reusing typed durable project-command operations and preserving their immediate-result contract through explicit bounded waiting or workflow state rather than adding new restricted execution capability.
