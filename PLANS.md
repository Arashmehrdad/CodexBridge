...
- Next unit: classify the remaining local command-profile and typed-validation surfaces, retaining durable focused validation primitives while removing any obsolete public restricted wrapper or duplicate profile metadata superseded by unrestricted PowerShell.
