...
PUBLIC_GATEWAY_INVENTORY_VERSION: Final[str] = "cf1.0.v7"
...
PUBLIC_GATEWAY_INVENTORY: Final[tuple[PublicGatewayInventoryEntry, ...]] = (
    ...
    _entry("skill_action", "skills", "soma.server", "bounded Skill lifecycle mutation", "direct package ingestion and lifecycle state mutation"),
    ...
    _entry("research_map_query", "research_map", "soma.server", "bounded exact-project research-map projection", "coverage, reviewed relation, semantic-search, and authoring-contract payload growth"),
