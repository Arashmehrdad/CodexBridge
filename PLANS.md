...
The V3 autonomous-company architecture is owner-accepted after the 2026-07-31 hierarchical-intelligence organisational research closure. `RELIABILITY-1 — EXISTING-RUNTIME-HARDENING` is closed. The post-closure `REL-028` one-shot Hermes profile/diagnostic regression is corrected and validated in source; activation requires a later controlled Soma restart and connector refresh. `V3-1A — INTERACTIVE WORKER SUBSTRATE` has passed its source acceptance gate through checkpoint expiry and recovery closure and is closed in source; runtime activation remains a later controlled operational gate. The corrected `V3-1B — KERNEL OF ONE ARCHITECTURE GATE` is accepted and closed. `V3-1B-SCHEMA-MODELS-1` is also accepted and closed in source with an inactive additive Company Kernel v1 schema, immutable models and copied-live compatibility proof. No successor implementation package is active. Real provider execution, public company operations, runtime activation and every later V3 outcome remain inactive. Reliability evidence remains in [`docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md`](docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md), V3-1A completion is [`docs/V3_1A_INTERACTION_COMMANDS_1_COMPLETION_2026-08-02.md`](docs/V3_1A_INTERACTION_COMMANDS_1_COMPLETION_2026-08-02.md), the V3-1B audit is [`docs/V3_1B_KERNEL_OF_ONE_ARCHITECTURE_ACCEPTANCE_AUDIT_2026-08-02.md`](docs/V3_1B_KERNEL_OF_ONE_ARCHITECTURE_ACCEPTANCE_AUDIT_2026-08-02.md), and the schema/models result is [`docs/V3_1B_SCHEMA_MODELS_1_RESULT_2026-08-02.md`](docs/V3_1B_SCHEMA_MODELS_1_RESULT_2026-08-02.md).
...
**Status:** the architecture gate and `V3-1B-SCHEMA-MODELS-1` are accepted and closed. The accepted source result is [`docs/V3_1B_SCHEMA_MODELS_1_RESULT_2026-08-02.md`](docs/V3_1B_SCHEMA_MODELS_1_RESULT_2026-08-02.md). No implementation package is active.

**Result:** Soma has an inactive additive Company Kernel v1 schema, immutable strict models, route-independent outcome identity and exact copied-live migration evidence. ProjectScope, Task, Run, process, lock, interaction and ResultPublication authority remain unchanged. The live service has not been migrated or activated.

**Boundary:** no public company gateway, Company/Mission bootstrap, plan/package action, attempt reservation, Task or Run launch, AcceptanceCommit action, projection, `reconcile_one`, real provider, worker-facing Soma MCP, department, scheduled autonomy, external mutation, restart, connector refresh, deployment or push.

**Next transition:** write and independently bound the next V3-1B package before any additional product work. Acceptance of the schema/models checkpoint does not activate later behavior.
...
**Status:** accepted and closed on 2026-08-02 after objective audit. All defects known at closure, `REL-001` through `REL-024`, are closed and live; later defects continue in the same ledger without reopening the lane. `REL-028` is closed in source after exact live-evidence reproduction and regression validation, but its runtime and revised connector schema are not active before a controlled restart and refresh. Restart/refresh convergence, disposable scenarios, integrity, documentation, and final quiet preflight passed for the original lane. The authoritative evidence is [`docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md`](docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md).
