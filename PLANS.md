...
**Active bounded corrective subgate:** `V3-1A-DESCENDANT-CONTAINMENT-1 — Root Exit Is Not Tree Exit`. Its gate is [docs/V3_1A_DESCENDANT_CONTAINMENT_1_GATE_2026-07-31.md](docs/V3_1A_DESCENDANT_CONTAINMENT_1_GATE_2026-07-31.md). It must separate root-exit confirmation from owned-tree absence proof, keep creator-handle-only cleanup non-terminal, retain locks and active parallel slots while descendant absence is unproven, and require a pre-established Job Object or equivalent proof before terminal failure/publication/lock release. Real Claude/Codex launch, provider accounts, live prompts/streams, public worker gateways, task-command expansion, direct worker MCP access, V3-1B work, production activation, and push remain forbidden.
