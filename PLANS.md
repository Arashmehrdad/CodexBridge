...
The V3 autonomous-company architecture is owner-accepted after the 2026-07-31 hierarchical-intelligence organisational research closure. `RELIABILITY-1 — EXISTING-RUNTIME-HARDENING` is now the sole active implementation lane before any further large V3 work. The owner-approved 2026-08-01 restart and connector refresh activated the validated source through `REL-024`; `REL-017` through `REL-024` are live, while targeted disposable scenario probes for `REL-012` through `REL-016` remain before lane acceptance. The V3-1A interaction-foundation architecture review remains preserved but parked; product implementation and every later V3 outcome remain paused. The active reliability contract and durable bug ledger are [`docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md`](docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md).
...
**Status:** active and the sole implementation lane from 2026-08-01. The restart/refresh activation batch is complete; the resumed `REL-023` service-log retention slice is closed and live, and targeted disposable probes for `REL-012` through `REL-016` are the next bounded acceptance work. The authoritative gate, phased validation plan, severity model, baseline, acceptance criteria, and bug ledger are in [`docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md`](docs/RELIABILITY_1_GATE_AND_BUG_LEDGER_2026-08-01.md).
