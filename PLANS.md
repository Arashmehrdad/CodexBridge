...
**Architecture status:** the owner-directed first V3 architecture design is now recorded in [docs/SOMA_ROADMAP_V3_AUTONOMOUS_COMPANY_ARCHITECTURE_2026-07-30.md](docs/SOMA_ROADMAP_V3_AUTONOMOUS_COMPANY_ARCHITECTURE_2026-07-30.md). It defines the autonomous-company destination, interactive chunk-by-chunk execution, Company Kernel authority and review briefs. It is pending Claude Opus architectural red-team, Codex repository-feasibility review, ChatGPT reconciliation and final owner acceptance. No V3 implementation lane is active.
