...
- The next classification unit must trace that active call chain and determine whether each caller needs durable project-command semantics, unrestricted PowerShell, or an explicitly retained synchronous local-analysis boundary.
