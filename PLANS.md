...
- Next unit: smoke-test the four recorded Andia replacement commands through unrestricted PowerShell, then remove only those four entries from the active external configuration while preserving the emitted rollback report.
