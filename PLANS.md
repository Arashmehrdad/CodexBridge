...
**Active subgate:** `V3-1A-ADAPTER-CONTRACT-1 — Provider Adapter Contract and Protocol Fixtures`. Its gate is [docs/V3_1A_ADAPTER_CONTRACT_1_GATE_2026-07-30.md](docs/V3_1A_ADAPTER_CONTRACT_1_GATE_2026-07-30.md). It is fixture-only: no provider launch, public worker gateway, task-command expansion, direct worker MCP access, V3-1B work, production activation, or push is authorised.
