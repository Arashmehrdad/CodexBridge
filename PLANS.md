...
- Next unit: inventory and migrate the remaining no-configuration `LocalAgentOrchestrator` construction sites, then remove the direct-subprocess runner fallback only after every production caller supplies durable application context.
