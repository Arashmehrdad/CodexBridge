...
from soma.supervisor import LocalSupervisorManager, SupervisorTaskRequest
from soma.local_coding import LocalCodingManager, LocalCodingRequest
...
def _memory_action_for_objective(objective: str) -> tuple[str | None, str]:
    ...
    if lowered == "show latest run memory":
        return "latest_run", ""
    if lowered == "continue last soma task":
