...
**Active corrective subgate:** `V3-1A-CANCELLATION-AUTHORITY-1 — Identity-Proven Canonical Cancellation`. Its gate is [docs/V3_1A_CANCELLATION_AUTHORITY_1_GATE_2026-07-30.md](docs/V3_1A_CANCELLATION_AUTHORITY_1_GATE_2026-07-30.md). The owner-approved contract forbids terminating a live PID without an exact matching recorded start identity; cancellation remains pending and the repository lock remains held when ownership is unprovable. Real Claude/Codex launch, provider accounts, live prompts/streams, public worker gateways, task-command expansion, direct worker MCP access, V3-1B work, production activation, and push remain forbidden.
