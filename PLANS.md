...
**Active bounded corrective subgate:** `V3-1A-LAUNCH-FAILURE-CONTAINMENT-1 — Identity-Safe Fresh-Launch Cleanup` is implemented locally and awaits independent acceptance. Its gate is [docs/V3_1A_LAUNCH_FAILURE_CONTAINMENT_1_GATE_2026-07-31.md](docs/V3_1A_LAUNCH_FAILURE_CONTAINMENT_1_GATE_2026-07-31.md), and its implementation evidence is [docs/V3_1A_LAUNCH_FAILURE_CONTAINMENT_1_COMPLETION_2026-07-31.md](docs/V3_1A_LAUNCH_FAILURE_CONTAINMENT_1_COMPLETION_2026-07-31.md). The correction removes identity-less raw-PID cleanup, distinguishes confirmed stop from uncertainty, retains locks on unconfirmed launch containment, makes the touched post-identity cleanup identity-scoped, and replaces weak source/conditional evidence with behavioral regressions. This is not acceptance of `V3-1A-PROCESS-IDENTITY-1`; an independent audit remains required. Accepted KILL_ON_JOB_CLOSE, environment, publication, cancellation-ordering, and launcher/child projection results remain binding. Real Claude/Codex launch, provider accounts, live prompts/streams, public worker gateways, task-command expansion, direct worker MCP access, V3-1B work, production activation, and push remain forbidden.
