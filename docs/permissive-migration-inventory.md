...
- Repository-configured profiles remain active internal durable workflow contracts. They are not public arbitrary-command routes and must be migrated individually because current configuration includes repository-specific validation, repair, and service-management operations.
