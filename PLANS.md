...
- Implementation commits through `35eca0bc06f1c646644e9e577e4ec2ff0bd26712`.
- Next executable unit: close the remaining R4 terminal-publication race and restart acceptance coverage, including concurrent natural completion versus cancellation, reconciliation of remotely completed cancellation after local interruption, and exactly-once canonical publication before the R4 exit gate.
