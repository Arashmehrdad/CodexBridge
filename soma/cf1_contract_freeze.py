...
CF1_COMPATIBILITY_INVARIANTS: Final[
    ...
    CompatibilityInvariantEvidence(
        ...
        (
            "soma.run_query_chunks:_redact_value",
    ...
    CompatibilityInvariantEvidence(
        ...
        ("soma.job_manager:JobManager.start_ssh_reviewed_script",),
        (
    ...
    CompatibilityInvariantEvidence(
        ...
        (
            "soma.safety:validate_repo_relative_path",
            "soma.repo_reader:_resolve_and_validate",
        ),
        (
    ...
    CompatibilityInvariantEvidence(
        ...
        (
            "soma.repo_reader:read_repo_file",
            "soma.repo_writer:_sha256_file",
        ),
        (
    ...
    CompatibilityInvariantEvidence(
        ...
        ("soma.git_tools:inspect_status_compact",),
        (
    ...
    CompatibilityInvariantEvidence(
        ...
        (
            "soma.repo_writer:preview_repo_patch",
            "soma.repo_writer:apply_previewed_repo_change",
        ),
        (
            "tests/test_repo_writer.py::test_apply_previewed_repo_change_rejects_tampered_payload",
            "tests/test_repo_writer.py::test_apply_previewed_repo_change_rejects_payload_filename_traversal",
