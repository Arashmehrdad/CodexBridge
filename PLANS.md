...
**Status:** architecture/schema foundations, Agent/Worker mechanics, `V3-1B-BOOTSTRAP-PLAN-AUTHORITY-1`, and `V3-1B-OUTCOME-ACCEPTANCE-1` are accepted. The active next package is bounded V3-1B projections + `reconcile_one`.
