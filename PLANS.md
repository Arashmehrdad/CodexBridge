...
**Sequence:** `V3-1A — INTERACTIVE-WORKER-SUBSTRATE-1` → `V3-1B — KERNEL-OF-ONE-1` → `V3-2 — ROLE-SCOPED-CAPABILITY-BROKER-1` → bounded collaboration → temporary organisation → broader autonomous-company outcomes.

**Active lane:** `V3-1A — INTERACTIVE-WORKER-SUBSTRATE-1`. Its authoritative contract is [docs/V3_1A_INTERACTIVE_WORKER_SUBSTRATE_PLAN_2026-07-30.md](docs/V3_1A_INTERACTIVE_WORKER_SUBSTRATE_PLAN_2026-07-30.md). No other implementation lane is active.
...
**Unaccepted package:** `V3-1A-PROCESS-IDENTITY-1 — Sanitised Launch and Owned-Tree Cancellation` is implemented at `bd007ec72ca7b2e24ffe7b4587570f0173a111d8` but failed independent acceptance. The audit is [docs/V3_1A_PROCESS_IDENTITY_1_ACCEPTANCE_AUDIT_2026-07-30.md](docs/V3_1A_PROCESS_IDENTITY_1_ACCEPTANCE_AUDIT_2026-07-30.md).

**Unaccepted corrective package:** `V3-1A-CANCELLATION-AUTHORITY-1 — Identity-Proven Canonical Cancellation` is implemented at `c1c5b535e9bb95b14b701546ce716653faf6688d` but failed independent acceptance. The audit is [docs/V3_1A_CANCELLATION_AUTHORITY_1_ACCEPTANCE_AUDIT_2026-07-30.md](docs/V3_1A_CANCELLATION_AUTHORITY_1_ACCEPTANCE_AUDIT_2026-07-30.md).

**Unaccepted corrective package:** `V3-1A-CANCELLATION-CLOSURE-1 — Publication, Identity Capture, and Crash Containment` is implemented at `89fb199c4a1a62fc464eed38d6b2836b3094941b` but failed independent acceptance. The audit is [docs/V3_1A_CANCELLATION_CLOSURE_1_ACCEPTANCE_AUDIT_2026-07-31.md](docs/V3_1A_CANCELLATION_CLOSURE_1_ACCEPTANCE_AUDIT_2026-07-31.md).

**Unaccepted corrective package:** `V3-1A-LAUNCH-FAILURE-CONTAINMENT-1 — Identity-Safe Fresh-Launch Cleanup` is implemented at `b6adcae3267607e26d471163153b2cbec92b41b5` but failed independent acceptance. The audit is [docs/V3_1A_LAUNCH_FAILURE_CONTAINMENT_1_ACCEPTANCE_AUDIT_2026-07-31.md](docs/V3_1A_LAUNCH_FAILURE_CONTAINMENT_1_ACCEPTANCE_AUDIT_2026-07-31.md). Its zero-raw-PID, structured uncertainty, lock-retention, identity-scoped cleanup, parallel-accounting, and CF1 corrections are retained.

**Implemented corrective package awaiting independent acceptance:** `V3-1A-DESCENDANT-CONTAINMENT-1 — Root Exit Is Not Tree Exit`. Its gate is [docs/V3_1A_DESCENDANT_CONTAINMENT_1_GATE_2026-07-31.md](docs/V3_1A_DESCENDANT_CONTAINMENT_1_GATE_2026-07-31.md), and implementation evidence is in [docs/V3_1A_DESCENDANT_CONTAINMENT_1_COMPLETION_2026-07-31.md](docs/V3_1A_DESCENDANT_CONTAINMENT_1_COMPLETION_2026-07-31.md). Root-exit confirmation is now separate from owned-tree absence proof; creator-handle-only cleanup remains non-terminal, retains locks and active parallel slots, and terminal failure/publication/lock release requires a pre-established Job Object or equivalent empty-tree proof. `V3-1A-PROCESS-IDENTITY-1` remains unaccepted pending independent audit. Real Claude/Codex launch, provider accounts, live prompts/streams, public worker gateways, task-command expansion, direct worker MCP access, V3-1B work, production activation, and push remain forbidden.
