...
**Active subgate:** `V3-1A-PROCESS-IDENTITY-1 — Sanitised Launch and Owned-Tree Cancellation`. Its gate is [docs/V3_1A_PROCESS_IDENTITY_1_GATE_2026-07-30.md](docs/V3_1A_PROCESS_IDENTITY_1_GATE_2026-07-30.md). It permits controlled local stand-in Windows process trees only. Real Claude/Codex launch, provider accounts, live prompts/streams, public worker gateways, task-command expansion, direct worker MCP access, V3-1B work, production activation, and push remain forbidden.
