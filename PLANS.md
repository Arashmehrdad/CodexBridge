...
- Next unit: add deterministic configuration-migration reporting for ordinary repository-configured validation profiles, preserve rollback data, and then remove those profiles from the active installation only after their PowerShell replacement commands are recorded and smoke-tested.
