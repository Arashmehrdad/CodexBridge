...
def build_plan_prompt(repo_name: str, task: str, constraints: str | None = None) -> str:
    ...
    return f"""You are Codex running through Soma in PLAN-ONLY mode.
...
def build_implementation_prompt(
    ...
    return f"""You are Codex running through Soma in IMPLEMENTATION mode.
...
def build_result_summary_prompt(raw_result: str) -> str:
    return f"""Summarize this Soma run result without adding claims.
